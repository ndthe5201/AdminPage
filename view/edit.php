                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header bg-primary">
                                <strong class="card-title text-light">Edit Product</strong>
                            </div>
                            <div class="card-body card-block">
                                <form action="../controller/Controller.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" value="<?php echo $data["tensp"]; ?>" id="txt_name" name="txt_name" placeholder=" " class="form-control"></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="id-input" class=" form-control-label">Mã Sản Phẩm</label></div>
                                        <div class="col-12 col-md-9"><input type="id" readonly value="<?php echo $data["masp"]; ?>" id="txt_id" name="txt_id" placeholder=" " class="form-control"></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="sl-input" class=" form-control-label">Số Lượng</label></div>
                                        <div class="col-12 col-md-9"><input type="soluong" value="<?php echo $data["soluong"]; ?>" id="txt_sl" name="txt_sl" placeholder=" " class="form-control"></div>
                                    </div>
                                    ...
                                    <div class="row form-group">
                                    <button type="submit" name="product_action" value="update" class="btn btn-primary " style="margin-left :10px">
